...
const Footer = () => {
  return (
    <div id="four-section" className="flex flex-col lg:flex-row justify-evenly p-10 pt-24 bg-black h-[450px]  dark:border-t-2 dark:border-slate-700 rounded-tr-[200px] w-full text-white">
        <div className="lg:w-1/2 space-y-4 lg:pr-32">
            <p className="text-3xl font-bold">Dream Agency</p>
            <p className="text-sm dark:text-dark-textColor-50 font-light">Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio, repellendus temporibus. Velit doloribus possimus aliquam natus dignissimos vel neque at reprehenderit expedita? Rerum nulla non, quibusdam deserunt ad amet eveniet!</p>
