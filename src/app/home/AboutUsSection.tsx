...
const AboutUsSection = () => {
  return (
    <div className='dark:text-dark-textColor-50 lg:min-h-screen flex flex-col lg:flex-row gap-24 items-center'>
        ...
        <div className='w-full flex flex-col justify-center pt-12 lg:pt-0 lg:min-h-screen text-5xl px-8'>
